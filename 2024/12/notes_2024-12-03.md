...
WHERE REGEXP_LIKE(b.write_up, '\{\{(\d+):([^}]+)\}\}')
...
```bash
https://{{Domain-Dev}}.{{base_url}}/browser/api/data/strinh/83000/1748/207257,207256,207255,207254,207253,207252,207251,207250,207249,207248,207247,207246,207245,207244,207242,207240,207239,207238,207237?token=M6QXY-CA9XU-Y3NQO-WVNVK-EJRBN
```
